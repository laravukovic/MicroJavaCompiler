...
public class SingleStmtLabelNoLabel extends Statement {

    private SingleStatement SingleStatement;

    public SingleStmtLabelNoLabel (SingleStatement SingleStatement) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("SingleStmtLabelNoLabel(\n");
